...
alias corrigir-trabalhos-pdf='rm -f ~/tmp/arqs_a_corrigir; for a in *.pdf; do echo sleep 0.5\; xournalpp \""$a"\" \& >> ~/tmp/arqs_a_corrigir; done; source ~/tmp/arqs_a_corrigir'
alias corrigir-trabalhos-xopp='rm -f ~/tmp/arqs_a_corrigir; for a in *.xopp; do echo sleep 0.75\; xournalpp \""$a"\" \& >> ~/tmp/arqs_a_corrigir; done; source ~/tmp/arqs_a_corrigir'
alias ffmpeg='ffmpeg -hide_banner'
alias ffprobe='ffprobe -hide_banner'
alias ffx265='ffmpeg_x265'
